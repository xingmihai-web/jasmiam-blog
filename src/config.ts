export default {
  ...
  WebSites: [
    ...
    { text: 'QQ', link: 'https://github.com/1498934815', icon: 'WebSite_github' },
    { text: 'QQ', link: 'mqqopensdkapi://bizAgent/qm/qr?url=https%3A%2F%2Fqm.qq.com%2Fcgi-bin%2Fqm%2Fqr%3Fk%3DtYrhpSkPVMGRrU_u6RBUcYwsXQAxh_b_%26jump_from%3D%26auth%3D%26app_name%3D%26authSig%3D%26source_id%3D3_40001', icon: 'WebStie_qq' },
  ],
  // 侧边栏展示
  AsideShow: {
    // 是否展示个人网站
